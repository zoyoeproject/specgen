...
body (qhead:(reference T_q_head)): monad (state CType) (reference T_q_node) :=
  ...
  __context %= match basic_block with
    | exception =>
      ...
      Head %= ret (q_head.Field.Head ___ssa4);
      ___ssa5 %= get_obj Head;
      ...
      __context %= match cmp with
        ...
        | false =>
          ...
          Tail %= ret (q_head.Field.Tail ___ssa10);
          ___ssa11 %= get_obj Tail;
          ...
          __context %= match cmp1 with
            ...
            | false =>
              ...
              Next %= ret (q_node.Field.Next ___ssa13);
              ___ssa14 %= get_obj Next;
              ___ssa15 %= get_obj qhead;
              Head3 %= ret (q_head.Field.Head ___ssa15);
              set_obj ___ssa14 Head3;;
              ___ssa17 %= get_obj node;
              Next4 %= ret (q_node.Field.Next ___ssa17);
              ___ssa18 %= get_obj Next4;
              Prev %= ret (q_node.Field.Prev ___ssa18);
              set_obj null Prev;;
              ret tt
              (* fallthrough *)
          end;
